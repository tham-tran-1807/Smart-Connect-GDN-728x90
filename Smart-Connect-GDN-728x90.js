...
lib.ssMetadata = [
		{name:"Smart_Connect_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Smart_Connect_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.SmartConnectGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(301).call(this.frame_301).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(300).to({_off:false},0).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(300).to({_off:false},0).to({y:10.45},12).wait(38));
...
// library properties:
lib.properties = {
	id: '824F032C3AEA24458B0041D92213D6B3',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Smart_Connect_GDN_728x90_atlas_1.png", id:"Smart_Connect_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['824F032C3AEA24458B0041D92213D6B3'] = {
